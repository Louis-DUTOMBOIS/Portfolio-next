...
const ProjectsPage = () => {
    const projects = [
        ...
        { name: 'Raytracer', image: '/raytracing2.png', url: 'https://github.com/Mizorami/Raytracer', description: 'Ce projet a été réalisé dans le cadre de la SAE S3.A.01. Le but était de créer une librairie générant des images avec raytracing. Dans un premier temps l\'application va lire un fichier donné puis, l\'image est générée en utilisant différentes méthodes et classes. Pour finir l\'image est télécharger. Le projet a été réalisé en Java. L\'implémentation de patrons de conception est le coeur du projet.' },
        { name: 'Toys Market', image: '/jeuInfo.png', url: 'https://github.com/Mizorami/InfoJeux/tree/develop', description: 'Ce projet a été réalisé dans le cadre du cours de MSI (Management des systèmes d\'information). Le but de ce projet est d\'afficher les différents et leur description provenant d\'une API. On pourra alors aussi modifier, supprimer ou encore crée un nouveau jeu.' }
    ];

    return (
        <section id="portfolio" className="bg-gray-900 text-white p-8">
